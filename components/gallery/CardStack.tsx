  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          className="pointer-events-none absolute inset-x-0 top-1/2 -translate-y-1/2 mx-auto h-48 w-[70%] rounded-full bg-bone/5 blur-3xl"
          aria-hidden="true"
        />
        <div
          className="pointer-events-none absolute inset-x-0 bottom-0 mx-auto h-32 w-[76%] rounded-full bg-black/30 blur-3xl"
          aria-hidden="true"
        />
        ...
        <div className="mt-6 flex items-center justify-center gap-3">
              ...
              return (
                <button
                  ...
                  className={cn(
                    ...
                    on ? "bg-bone" : "bg-bone/30 hover:bg-bone/50",
                  )}
          ...
          {activeItem.href ? (
            <Link
              ...
              className="text-graphite hover:text-bone transition"
